...
class Request:
    def __init__(
        ...
        # [DeltaServe] True for injected finetuning samples (prefill-only, routed
        # to the FT LoRA adapter, retired same step, never surfaced to the
        # frontend). Set by the FT injector after construction.
